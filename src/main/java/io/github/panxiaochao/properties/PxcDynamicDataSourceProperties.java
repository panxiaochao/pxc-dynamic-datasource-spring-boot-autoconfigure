...
import io.github.panxiaochao.banner.PxcBanner;
 ...
 * @since 2022/1/4
 */
@ConfigurationProperties(prefix = PxcDynamicDataSourceProperties.PXCDYNAMIC_PREFIX, ignoreInvalidFields = true)
public class PxcDynamicDataSourceProperties implements InitializingBean {
    /**
     * 属性前缀
     */
    public static final String PXCDYNAMIC_PREFIX = "pxc.datasource";
    /**
     * 是否显示自定义 banner
     */
    ...
    private Map<String, PxcDynamicDataSourceProperties.DruidProperties> dynamic;
    private String type;
